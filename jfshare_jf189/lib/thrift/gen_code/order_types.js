...
OrderInfo = module.exports.OrderInfo = function(args) {
  ...
  if (args) {
    ...
    if (args.postageTemplateId !== undefined && args.postageTemplateId !== null) {
...
Order = module.exports.Order = function(args) {
  ...
  if (args) {
    ...
    if (args.thirdScore !== undefined && args.thirdScore !== null) {
...
BatchDeliverResult = module.exports.BatchDeliverResult = function(args) {
  ...
  if (args) {
    ...
    if (args.failInfo !== undefined && args.failInfo !== null) {
      this.failInfo = Thrift.copyList(args.failInfo, [ttypes.BatchDeliverFailInfo]);
    }
  }
};
...
BatchDeliverParam = module.exports.BatchDeliverParam = function(args) {
  ...
  this.fileKey = null;
  if (args) {
    if (args.deliverType !== undefined && args.deliverType !== null) {
      this.deliverType = args.deliverType;
    }
    if (args.orderList !== undefined && args.orderList !== null) {
      this.orderList = Thrift.copyList(args.orderList, [ttypes.Order]);
    }
    if (args.fileName !== undefined && args.fileName !== null) {
      this.fileName = args.fileName;
    }
    if (args.fileKey !== undefined && args.fileKey !== null) {
...
ExportOrderInfo = module.exports.ExportOrderInfo = function(args) {
  ...
  if (args) {
    ...
    if (args.opState !== undefined && args.opState !== null) {
      this.opState = args.opState;
    }
    if (args.opUrl !== undefined && args.opUrl !== null) {
      this.opUrl = args.opUrl;
    }
    if (args.conditions !== undefined && args.conditions !== null) {
      this.conditions = new ttypes.OrderQueryConditions(args.conditions);
    }
    if (args.actualCount !== undefined && args.actualCount !== null) {
      this.actualCount = args.actualCount;
    }
    if (args.totalCount !== undefined && args.totalCount !== null) {
      this.totalCount = args.totalCount;
    }
    if (args.fsType !== undefined && args.fsType !== null) {
...
ExportOrderResult = module.exports.ExportOrderResult = function(args) {
  ...
  if (args) {
    ...
    if (args.exportOrderInfo !== undefined && args.exportOrderInfo !== null) {
      this.exportOrderInfo = Thrift.copyList(args.exportOrderInfo, [ttypes.ExportOrderInfo]);
    }
  }
};
