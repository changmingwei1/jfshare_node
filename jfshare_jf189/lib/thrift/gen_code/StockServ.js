...
StockServ_setStock_args = function(args) {
  ...
  this.stockInfo = null;
  if (args) {
    if (args.tranId !== undefined && args.tranId !== null) {
...
StockServ_queryStock_args = function(args) {
  ...
  if (args) {
    if (args.param !== undefined && args.param !== null) {
      this.param = new ttypes.QueryParam(args.param);
    }
  }
};
...
StockServ_queryStock_result = function(args) {
  ...
  if (args) {
    if (args.success !== undefined && args.success !== null) {
      this.success = new ttypes.StockResult(args.success);
    }
  }
};
...
StockServ_batchQueryStock_args = function(args) {
  ...
  if (args) {
    if (args.param !== undefined && args.param !== null) {
      this.param = new ttypes.BatchQueryParam(args.param);
    }
  }
};
...
StockServ_batchQueryStock_result = function(args) {
  ...
  if (args) {
    if (args.success !== undefined && args.success !== null) {
      this.success = new ttypes.BatchStockResult(args.success);
    }
  }
};
...
StockServ_lockStock_result = function(args) {
  ...
  if (args) {
    if (args.success !== undefined && args.success !== null) {
      this.success = new ttypes.LockStockResult(args.success);
    }
  }
};
  ...
  if (this._handler.setStock.length === 2) {
    Q.fcall(this._handler.setStock, args.tranId, args.stockInfo)
      .then(function(result) {
        ...
        output.writeMessageBegin("setStock", Thrift.MessageType.EXCEPTION, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      });
  ...
  if (this._handler.queryStock.length === 1) {
    Q.fcall(this._handler.queryStock, args.param)
      .then(function(result) {
        ...
        var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("queryStock", Thrift.MessageType.EXCEPTION, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      });
  ...
  if (this._handler.batchQueryStock.length === 1) {
    Q.fcall(this._handler.batchQueryStock, args.param)
      .then(function(result) {
        ...
        var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("batchQueryStock", Thrift.MessageType.EXCEPTION, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      });
  ...
  if (this._handler.lockStock.length === 2) {
    Q.fcall(this._handler.lockStock, args.tranId, args.lockInfoList)
      .then(function(result) {
        ...
        var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("lockStock", Thrift.MessageType.EXCEPTION, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      });
  ...
  if (this._handler.releaseStock.length === 2) {
    Q.fcall(this._handler.releaseStock, args.tranId, args.lockInfoList)
      .then(function(result) {
        ...
        var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("releaseStock", Thrift.MessageType.EXCEPTION, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      });
  ...
  if (this._handler.releaseLockCount.length === 2) {
    Q.fcall(this._handler.releaseLockCount, args.tranId, args.lockInfoList)
      .then(function(result) {
        ...
        var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("releaseLockCount", Thrift.MessageType.EXCEPTION, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      });
  ...
  if (this._handler.removeStock.length === 1) {
    Q.fcall(this._handler.removeStock, args.productId)
      .then(function(result) {
        ...
        var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("removeStock", Thrift.MessageType.EXCEPTION, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      });
  ...
  if (this._handler.createStock.length === 2) {
    Q.fcall(this._handler.createStock, args.tranId, args.stockInfo)
      .then(function(result) {
        ...
        var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("createStock", Thrift.MessageType.EXCEPTION, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      });
  ...
  if (this._handler.supplyStock.length === 2) {
    Q.fcall(this._handler.supplyStock, args.tranId, args.stockInfo)
      .then(function(result) {
        ...
        var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("supplyStock", Thrift.MessageType.EXCEPTION, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      });
  ...
  if (this._handler.supplyFullStock.length === 2) {
    Q.fcall(this._handler.supplyFullStock, args.tranId, args.stockInfo)
      .then(function(result) {
        ...
        var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("supplyFullStock", Thrift.MessageType.EXCEPTION, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      });
