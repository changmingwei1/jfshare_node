...
OrderServ_deliverVir_args = function(args) {
  ...
  if (args) {
    if (args.param !== undefined && args.param !== null) {
      this.param = new ttypes.DeliverVirParam(args.param);
    }
  }
};
...
OrderServ_queryExportOrderInfo_result = function(args) {
  ...
  if (args) {
    if (args.success !== undefined && args.success !== null) {
      this.success = new ttypes.ExportOrderResult(args.success);
    }
  }
};
...
OrderServ_orderProfileQuery_result = function(args) {
  ...
  if (args) {
    if (args.success !== undefined && args.success !== null) {
      this.success = new ttypes.OrderProfileResult(args.success);
    }
  }
};
...
OrderServ_queryOrderDetail_result = function(args) {
  ...
  if (args) {
    if (args.success !== undefined && args.success !== null) {
      this.success = new ttypes.OrderDetailResult(args.success);
    }
  }
};
...
OrderServ_orderStateQuery_result = function(args) {
  ...
  if (args) {
    if (args.success !== undefined && args.success !== null) {
      this.success = new ttypes.OrderStateResult(args.success);
    }
  }
};
...
OrderServ_payApply_args = function(args) {
  ...
  if (args) {
    if (args.param !== undefined && args.param !== null) {
      this.param = new ttypes.PayParam(args.param);
    }
  }
};
...
OrderServ_payFinish_args = function(args) {
  this.payRes = null;
  if (args) {
    if (args.payRes !== undefined && args.payRes !== null) {
...
OrderServ_payState_result = function(args) {
  ...
  if (args) {
    if (args.success !== undefined && args.success !== null) {
      this.success = new ttypes.PayStateResult(args.success);
    }
  }
};
...
OrderServ_batchDeliverOrder_args = function(args) {
  ...
  if (args) {
    ...
    if (args.param !== undefined && args.param !== null) {
      this.param = new ttypes.BatchDeliverParam(args.param);
    }
  }
};
...
OrderServ_batchDeliverOrder_result = function(args) {
  ...
  if (args) {
    if (args.success !== undefined && args.success !== null) {
      this.success = new ttypes.BatchDeliverResult(args.success);
    }
  }
};
  ...
  if (this._handler.createOrder.length === 1) {
    Q.fcall(this._handler.createOrder, args.orderList)
      .then(function(result) {
        ...
        output.writeMessageBegin("createOrder", Thrift.MessageType.EXCEPTION, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      });
  ...
  if (this._handler.updateDeliverInfo.length === 3) {
    Q.fcall(this._handler.updateDeliverInfo, args.userType, args.userId, args.deliverInfo)
      .then(function(result) {
        ...
        var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("updateDeliverInfo", Thrift.MessageType.EXCEPTION, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      });
  ...
  if (this._handler.deliver.length === 2) {
    Q.fcall(this._handler.deliver, args.sellerId, args.deliverInfo)
      .then(function(result) {
        ...
        var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("deliver", Thrift.MessageType.EXCEPTION, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      });
  ...
  if (this._handler.deliverVir.length === 1) {
    Q.fcall(this._handler.deliverVir, args.param)
      .then(function(result) {
        ...
        var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("deliverVir", Thrift.MessageType.EXCEPTION, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      });
  ...
  if (this._handler.updateExpressInfo.length === 5) {
    Q.fcall(this._handler.updateExpressInfo, args.sellerId, args.orderId, args.expressId, args.expressNo, args.expressName)
      .then(function(result) {
        ...
        var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("updateExpressInfo", Thrift.MessageType.EXCEPTION, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      });
  ...
  if (this._handler.confirmReceipt.length === 3) {
    Q.fcall(this._handler.confirmReceipt, args.userType, args.userId, args.orderId)
      .then(function(result) {
        ...
        var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("confirmReceipt", Thrift.MessageType.EXCEPTION, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      });
  ...
  if (this._handler.cancelOrder.length === 4) {
    Q.fcall(this._handler.cancelOrder, args.userType, args.userId, args.orderId, args.reason)
      .then(function(result) {
        ...
        var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("cancelOrder", Thrift.MessageType.EXCEPTION, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      });
  ...
  if (this._handler.queryExportOrderInfo.length === 2) {
    Q.fcall(this._handler.queryExportOrderInfo, args.sellerId, args.conditions)
      .then(function(result) {
        ...
        var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("queryExportOrderInfo", Thrift.MessageType.EXCEPTION, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      });
  ...
  if (this._handler.orderProfileQuery.length === 3) {
    Q.fcall(this._handler.orderProfileQuery, args.userType, args.userId, args.conditions)
      .then(function(result) {
        ...
        var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("orderProfileQuery", Thrift.MessageType.EXCEPTION, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      });
  ...
  if (this._handler.queryOrderDetail.length === 3) {
    Q.fcall(this._handler.queryOrderDetail, args.userType, args.userId, args.orderId)
      .then(function(result) {
        ...
        var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("queryOrderDetail", Thrift.MessageType.EXCEPTION, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      });
  ...
  if (this._handler.orderStateQuery.length === 3) {
    Q.fcall(this._handler.orderStateQuery, args.userType, args.userId, args.conditions)
      .then(function(result) {
        ...
        var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("orderStateQuery", Thrift.MessageType.EXCEPTION, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      });
  ...
  if (this._handler.payApply.length === 1) {
    Q.fcall(this._handler.payApply, args.param)
      .then(function(result) {
        ...
        var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("payApply", Thrift.MessageType.EXCEPTION, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      });
  ...
  if (this._handler.payFinish.length === 1) {
    Q.fcall(this._handler.payFinish, args.payRes)
      .then(function(result) {
        ...
        var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("payFinish", Thrift.MessageType.EXCEPTION, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      });
  ...
  if (this._handler.payState.length === 1) {
    Q.fcall(this._handler.payState, args.payState)
      .then(function(result) {
        ...
        var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("payState", Thrift.MessageType.EXCEPTION, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      });
  ...
  if (this._handler.batchExportOrder.length === 2) {
    Q.fcall(this._handler.batchExportOrder, args.sellerId, args.conditions)
      .then(function(result) {
        ...
        var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("batchExportOrder", Thrift.MessageType.EXCEPTION, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      });
  ...
  if (this._handler.batchDeliverOrder.length === 2) {
    Q.fcall(this._handler.batchDeliverOrder, args.sellerId, args.param)
      .then(function(result) {
        ...
        var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("batchDeliverOrder", Thrift.MessageType.EXCEPTION, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      });
