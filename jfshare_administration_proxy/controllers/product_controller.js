...
router.post('/get', function(request, response, next) {
   ...
   // var params = request.query;
    ...
    try{
        ...
        var sku = {"sku":[{"key":{"id":1,"value":"不叫颜色可否"},"values":[{"id":1,"value":"军绿色","image":"40923A2995EA7A154A02C3C0D210F1BA.jpg","isReplace":"0"},{"id":"6","value":"浅绿色","image":"B37CC07E0E8EBB7E5E805204FBA22824.jpg","isReplace":"0"},{"id":"11","value":"深蓝色","image":"CC94147A0A54810BF8380D47DF9E6FC7.jpg","isReplace":"0"}]},{"key":{"id":"100","value":"自定义规格"},"values":[{"id":"101","value":"女神"},{"id":"102","value":"男神"}]}]};

        product.skuTemplate = sku;


        var attribute = [{"id":"1","name":"产地","value":""},{"id":"2","name":"寿命","value":""},{"id":"3","name":"型号","value":""}];
