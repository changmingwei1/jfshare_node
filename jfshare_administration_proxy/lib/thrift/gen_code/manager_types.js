...
QueryConditions = module.exports.QueryConditions = function(args) {
  ...
  if (args) {
    ...
    if (args.recordCount !== undefined && args.recordCount !== null) {
...
ProductOptResult = module.exports.ProductOptResult = function(args) {
  ...
  if (args) {
    ...
    if (args.productOptRecords !== undefined && args.productOptRecords !== null) {
      this.productOptRecords = Thrift.copyList(args.productOptRecords, [ttypes.ProductOpt]);
    }
  }
};
...
Commissioner = module.exports.Commissioner = function(args) {
  ...
  this.pwdEnc = null;
  if (args) {
    if (args.csId !== undefined && args.csId !== null) {
      this.csId = args.csId;
    }
    if (args.loginName !== undefined && args.loginName !== null) {
      this.loginName = args.loginName;
    }
    if (args.csName !== undefined && args.csName !== null) {
...
AdvertSlotImage = module.exports.AdvertSlotImage = function(args) {
  ...
  if (args) {
    ...
    if (args.advertId !== undefined && args.advertId !== null) {
    ...
    if (args.jump !== undefined && args.jump !== null) {
      this.jump = args.jump;
    }
    if (args.isOnline !== undefined && args.isOnline !== null) {
...
AdvertSlotImageListResult = module.exports.AdvertSlotImageListResult = function(args) {
  ...
  if (args) {
    ...
    if (args.slotImageList !== undefined && args.slotImageList !== null) {
      this.slotImageList = Thrift.copyList(args.slotImageList, [ttypes.AdvertSlotImage]);
    }
  }
};
