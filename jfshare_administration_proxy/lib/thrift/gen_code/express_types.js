...
SubscribeReq = module.exports.SubscribeReq = function(args) {
  ...
  if (args) {
    ...
    if (args.fromAddr !== undefined) {
      this.fromAddr = args.fromAddr;
    }
    if (args.toAddr !== undefined) {
      this.toAddr = args.toAddr;
    }
    if (args.orderId !== undefined) {
      this.orderId = args.orderId;
    }
    if (args.comId !== undefined) {
      this.comId = args.comId;
    }
    if (args.mobiletelephone !== undefined) {
...
SubscribeReq.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 3:
      if (ftype == Thrift.Type.STRING) {
        this.fromAddr = input.readString();
      } else {
        input.skip(ftype);
      }
      break;
      ...
      case 7:
      if (ftype == Thrift.Type.STRING) {
        this.mobiletelephone = input.readString();
      } else {
        input.skip(ftype);
      }
      break;
      ...
      case 9:
      if (ftype == Thrift.Type.STRING) {
        this.commodity = input.readString();
      } else {
        input.skip(ftype);
      }
      break;
...
SubscribeReq.prototype.write = function(output) {
  ...
  if (this.fromAddr !== null && this.fromAddr !== undefined) {
    output.writeFieldBegin('fromAddr', Thrift.Type.STRING, 3);
    output.writeString(this.fromAddr);
    output.writeFieldEnd();
  }
  if (this.toAddr !== null && this.toAddr !== undefined) {
    output.writeFieldBegin('toAddr', Thrift.Type.STRING, 4);
    output.writeString(this.toAddr);
    output.writeFieldEnd();
  }
  if (this.orderId !== null && this.orderId !== undefined) {
    output.writeFieldBegin('orderId', Thrift.Type.STRING, 5);
  ...
  if (this.comId !== null && this.comId !== undefined) {
    output.writeFieldBegin('comId', Thrift.Type.I32, 6);
    output.writeI32(this.comId);
    output.writeFieldEnd();
  }
  if (this.mobiletelephone !== null && this.mobiletelephone !== undefined) {
    output.writeFieldBegin('mobiletelephone', Thrift.Type.STRING, 7);
    output.writeString(this.mobiletelephone);
    output.writeFieldEnd();
  }
  if (this.seller !== null && this.seller !== undefined) {
    output.writeFieldBegin('seller', Thrift.Type.STRING, 8);
    output.writeString(this.seller);
    output.writeFieldEnd();
  }
  if (this.commodity !== null && this.commodity !== undefined) {
    output.writeFieldBegin('commodity', Thrift.Type.STRING, 9);
    output.writeString(this.commodity);
    output.writeFieldEnd();
  }
  output.writeFieldStop();
  output.writeStructEnd();
...
ExpressParams.prototype.write = function(output) {
  ...
  if (this.comId !== null && this.comId !== undefined) {
    output.writeFieldBegin('comId', Thrift.Type.I32, 5);
    output.writeI32(this.comId);
    output.writeFieldEnd();
  }
  output.writeFieldStop();
