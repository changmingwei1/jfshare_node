...
ScoreCardServ_queryUnusedCouponListByUserId_args = function(args) {
  this.userId = null;
  this.tradeCode = null;
  if (args) {
    if (args.userId !== undefined) {
...
ScoreCardServ_queryUnusedCouponListByUserId_args.prototype = {};
ScoreCardServ_queryUnusedCouponListByUserId_args.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
...
ScoreCardServ_queryUnusedCouponListByUserId_args.prototype.write = function(output) {
  output.writeStructBegin('ScoreCardServ_queryUnusedCouponListByUserId_args');
  if (this.userId !== null && this.userId !== undefined) {
    output.writeFieldBegin('userId', Thrift.Type.I32, 1);
    output.writeI32(this.userId);
    output.writeFieldEnd();
...
ScoreCardServ_queryUnusedCouponListByUserId_result = function(args) {
  this.success = null;
  if (args) {
    if (args.success !== undefined) {
      this.success = args.success;
...
ScoreCardServ_queryUnusedCouponListByUserId_result.prototype = {};
ScoreCardServ_queryUnusedCouponListByUserId_result.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
    ...
    switch (fid)
    {
      case 0:
      if (ftype == Thrift.Type.STRUCT) {
        this.success = new ttypes.UnusedCouponListResult();
        this.success.read(input);
      } else {
        input.skip(ftype);
      }
...
ScoreCardServ_queryUnusedCouponListByUserId_result.prototype.write = function(output) {
  output.writeStructBegin('ScoreCardServ_queryUnusedCouponListByUserId_result');
  if (this.success !== null && this.success !== undefined) {
    output.writeFieldBegin('success', Thrift.Type.STRUCT, 0);
    this.success.write(output);
    output.writeFieldEnd();
...
ScoreCardServ_queryDiscountList_args.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 2:
      if (ftype == Thrift.Type.STRUCT) {
        this.param = new ttypes.DiscountListParam();
        this.param.read(input);
      } else {
        input.skip(ftype);
      }
...
ScoreCardServ_exportDiscountList_args = function(args) {
  this.pwd = null;
  this.activId = null;
  this.param = null;
  if (args) {
...
ScoreCardServ_exportDiscountList_args.prototype = {};
ScoreCardServ_exportDiscountList_args.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
...
ScoreCardServ_exportDiscountList_args.prototype.write = function(output) {
  output.writeStructBegin('ScoreCardServ_exportDiscountList_args');
...
ScoreCardServ_exportDiscountList_result = function(args) {
  this.success = null;
  if (args) {
    if (args.success !== undefined) {
      this.success = args.success;
...
ScoreCardServ_exportDiscountList_result.prototype = {};
ScoreCardServ_exportDiscountList_result.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
...
ScoreCardServ_exportDiscountList_result.prototype.write = function(output) {
  output.writeStructBegin('ScoreCardServ_exportDiscountList_result');
  if (this.success !== null && this.success !== undefined) {
    output.writeFieldBegin('success', Thrift.Type.STRUCT, 0);
    this.success.write(output);
    output.writeFieldEnd();
...
ScoreCardServ_updateDiscountStateAndOrderId_args.prototype.write = function(output) {
  ...
  if (this.orderId !== null && this.orderId !== undefined) {
    ...
    for (var iter118 in this.orderId)
    {
      if (this.orderId.hasOwnProperty(iter118))
      {
        iter118 = this.orderId[iter118];
  ...
  if (this.couponId !== null && this.couponId !== undefined) {
    ...
    for (var iter119 in this.couponId)
    {
      if (this.couponId.hasOwnProperty(iter119))
      {
        iter119 = this.couponId[iter119];
...
ScoreCardServ_queryDiscountByCouponId_args = function(args) {
  this.couponId = null;
  if (args) {
    if (args.couponId !== undefined) {
      this.couponId = args.couponId;
...
ScoreCardServ_queryDiscountByCouponId_args.prototype = {};
ScoreCardServ_queryDiscountByCouponId_args.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
...
ScoreCardServ_queryDiscountByCouponId_args.prototype.write = function(output) {
  output.writeStructBegin('ScoreCardServ_queryDiscountByCouponId_args');
  if (this.couponId !== null && this.couponId !== undefined) {
    output.writeFieldBegin('couponId', Thrift.Type.STRING, 1);
    output.writeString(this.couponId);
    output.writeFieldEnd();
...
ScoreCardServ_queryDiscountByCouponId_result = function(args) {
  this.success = null;
  if (args) {
    if (args.success !== undefined) {
      this.success = args.success;
...
ScoreCardServ_queryDiscountByCouponId_result.prototype = {};
ScoreCardServ_queryDiscountByCouponId_result.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
...
ScoreCardServ_queryDiscountByCouponId_result.prototype.write = function(output) {
  output.writeStructBegin('ScoreCardServ_queryDiscountByCouponId_result');
  if (this.success !== null && this.success !== undefined) {
    output.writeFieldBegin('success', Thrift.Type.STRUCT, 0);
    this.success.write(output);
    output.writeFieldEnd();
...
ScoreCardServ_cancleDiscountState_args = function(args) {
  this.orderId = null;
  if (args) {
    if (args.orderId !== undefined) {
      this.orderId = args.orderId;
...
ScoreCardServ_cancleDiscountState_args.prototype = {};
ScoreCardServ_cancleDiscountState_args.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
...
ScoreCardServ_cancleDiscountState_args.prototype.write = function(output) {
  output.writeStructBegin('ScoreCardServ_cancleDiscountState_args');
  if (this.orderId !== null && this.orderId !== undefined) {
...
ScoreCardServ_cancleDiscountState_result = function(args) {
  this.success = null;
  if (args) {
    if (args.success !== undefined) {
      this.success = args.success;
...
ScoreCardServ_cancleDiscountState_result.prototype = {};
ScoreCardServ_cancleDiscountState_result.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
...
ScoreCardServ_cancleDiscountState_result.prototype.write = function(output) {
  output.writeStructBegin('ScoreCardServ_cancleDiscountState_result');
  if (this.success !== null && this.success !== undefined) {
    output.writeFieldBegin('success', Thrift.Type.STRUCT, 0);
    this.success.write(output);
    output.writeFieldEnd();
...
ScoreCardServ_queryDiscountState_args = function(args) {
  this.couponId = null;
  if (args) {
    if (args.couponId !== undefined) {
      this.couponId = args.couponId;
...
ScoreCardServ_queryDiscountState_args.prototype = {};
ScoreCardServ_queryDiscountState_args.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
...
ScoreCardServ_queryDiscountState_args.prototype.write = function(output) {
  output.writeStructBegin('ScoreCardServ_queryDiscountState_args');
  if (this.couponId !== null && this.couponId !== undefined) {
    output.writeFieldBegin('couponId', Thrift.Type.STRING, 1);
    output.writeString(this.couponId);
    output.writeFieldEnd();
...
ScoreCardServ_queryDiscountState_result = function(args) {
  this.success = null;
  if (args) {
    if (args.success !== undefined) {
      this.success = args.success;
...
ScoreCardServ_queryDiscountState_result.prototype = {};
ScoreCardServ_queryDiscountState_result.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
    ...
    switch (fid)
    {
      case 0:
      if (ftype == Thrift.Type.STRUCT) {
        this.success = new ttypes.DiscountCouponResult();
        this.success.read(input);
      } else {
        input.skip(ftype);
      }
...
ScoreCardServ_queryDiscountState_result.prototype.write = function(output) {
  output.writeStructBegin('ScoreCardServ_queryDiscountState_result');
  if (this.success !== null && this.success !== undefined) {
    output.writeFieldBegin('success', Thrift.Type.STRUCT, 0);
    this.success.write(output);
    output.writeFieldEnd();
...
ScoreCardServClient.prototype.queryUnusedCouponListByUserId = function(userId, tradeCode, callback) {
  this._seqid = this.new_seqid();
  if (callback === undefined) {
    var _defer = Q.defer();
    this._reqs[this.seqid()] = function(error, result) {
    ...
    this.send_queryUnusedCouponListByUserId(userId, tradeCode);
    return _defer.promise;
  } else {
    this._reqs[this.seqid()] = callback;
    this.send_queryUnusedCouponListByUserId(userId, tradeCode);
...
ScoreCardServClient.prototype.send_queryUnusedCouponListByUserId = function(userId, tradeCode) {
  var output = new this.pClass(this.output);
  output.writeMessageBegin('queryUnusedCouponListByUserId', Thrift.MessageType.CALL, this.seqid());
  var args = new ScoreCardServ_queryUnusedCouponListByUserId_args();
  args.userId = userId;
  args.tradeCode = tradeCode;
  args.write(output);
  output.writeMessageEnd();
  return this.output.flush();
};

ScoreCardServClient.prototype.recv_queryUnusedCouponListByUserId = function(input,mtype,rseqid) {
  var callback = this._reqs[rseqid] || function() {};
  delete this._reqs[rseqid];
  if (mtype == Thrift.MessageType.EXCEPTION) {
    var x = new Thrift.TApplicationException();
  ...
  var result = new ScoreCardServ_queryUnusedCouponListByUserId_result();
  result.read(input);
  input.readMessageEnd();
  ...
  return callback('queryUnusedCouponListByUserId failed: unknown result');
};
...
ScoreCardServClient.prototype.queryAllDiscountActiv = function(pagination, callback) {
  this._seqid = this.new_seqid();
  if (callback === undefined) {
    var _defer = Q.defer();
    this._reqs[this.seqid()] = function(error, result) {
    ...
    this.send_queryAllDiscountActiv(pagination);
    return _defer.promise;
  } else {
    this._reqs[this.seqid()] = callback;
    this.send_queryAllDiscountActiv(pagination);
...
ScoreCardServClient.prototype.send_queryAllDiscountActiv = function(pagination) {
  var output = new this.pClass(this.output);
...
ScoreCardServClient.prototype.queryDiscountList = function(activ, param, pagination, callback) {
  this._seqid = this.new_seqid();
  if (callback === undefined) {
    var _defer = Q.defer();
    this._reqs[this.seqid()] = function(error, result) {
    ...
    this.send_queryDiscountList(activ, param, pagination);
    return _defer.promise;
  } else {
    this._reqs[this.seqid()] = callback;
    this.send_queryDiscountList(activ, param, pagination);
...
ScoreCardServClient.prototype.send_queryDiscountList = function(activ, param, pagination) {
  var output = new this.pClass(this.output);
...
ScoreCardServClient.prototype.exportDiscountList = function(pwd, activId, param, callback) {
  this._seqid = this.new_seqid();
  if (callback === undefined) {
    var _defer = Q.defer();
    this._reqs[this.seqid()] = function(error, result) {
    ...
    this.send_exportDiscountList(pwd, activId, param);
    return _defer.promise;
  } else {
    this._reqs[this.seqid()] = callback;
    this.send_exportDiscountList(pwd, activId, param);
...
ScoreCardServClient.prototype.send_exportDiscountList = function(pwd, activId, param) {
  var output = new this.pClass(this.output);
  output.writeMessageBegin('exportDiscountList', Thrift.MessageType.CALL, this.seqid());
  var args = new ScoreCardServ_exportDiscountList_args();
  args.pwd = pwd;
...
ScoreCardServClient.prototype.recv_exportDiscountList = function(input,mtype,rseqid) {
  var callback = this._reqs[rseqid] || function() {};
  delete this._reqs[rseqid];
  if (mtype == Thrift.MessageType.EXCEPTION) {
    var x = new Thrift.TApplicationException();
  ...
  var result = new ScoreCardServ_exportDiscountList_result();
  result.read(input);
  input.readMessageEnd();
  ...
  return callback('exportDiscountList failed: unknown result');
};
...
ScoreCardServClient.prototype.InvalidCoupon = function(couponId, adminPwd, callback) {
  this._seqid = this.new_seqid();
  if (callback === undefined) {
    var _defer = Q.defer();
    this._reqs[this.seqid()] = function(error, result) {
    ...
    this.send_InvalidCoupon(couponId, adminPwd);
    return _defer.promise;
  } else {
    this._reqs[this.seqid()] = callback;
    this.send_InvalidCoupon(couponId, adminPwd);
...
ScoreCardServClient.prototype.send_InvalidCoupon = function(couponId, adminPwd) {
  var output = new this.pClass(this.output);
...
ScoreCardServClient.prototype.queryDiscountByCouponId = function(couponId, callback) {
  this._seqid = this.new_seqid();
  if (callback === undefined) {
    var _defer = Q.defer();
    this._reqs[this.seqid()] = function(error, result) {
    ...
    this.send_queryDiscountByCouponId(couponId);
    return _defer.promise;
  } else {
    this._reqs[this.seqid()] = callback;
    this.send_queryDiscountByCouponId(couponId);
...
ScoreCardServClient.prototype.send_queryDiscountByCouponId = function(couponId) {
  var output = new this.pClass(this.output);
  output.writeMessageBegin('queryDiscountByCouponId', Thrift.MessageType.CALL, this.seqid());
  var args = new ScoreCardServ_queryDiscountByCouponId_args();
  args.couponId = couponId;
  args.write(output);
  output.writeMessageEnd();
  return this.output.flush();
...
ScoreCardServClient.prototype.recv_queryDiscountByCouponId = function(input,mtype,rseqid) {
  var callback = this._reqs[rseqid] || function() {};
  delete this._reqs[rseqid];
  if (mtype == Thrift.MessageType.EXCEPTION) {
    var x = new Thrift.TApplicationException();
  ...
  var result = new ScoreCardServ_queryDiscountByCouponId_result();
  result.read(input);
  input.readMessageEnd();
  ...
  return callback('queryDiscountByCouponId failed: unknown result');
};
ScoreCardServClient.prototype.cancleDiscountState = function(orderId, callback) {
  this._seqid = this.new_seqid();
  if (callback === undefined) {
    var _defer = Q.defer();
    this._reqs[this.seqid()] = function(error, result) {
    ...
    this.send_cancleDiscountState(orderId);
    return _defer.promise;
  } else {
    this._reqs[this.seqid()] = callback;
    this.send_cancleDiscountState(orderId);
...
ScoreCardServClient.prototype.send_cancleDiscountState = function(orderId) {
  var output = new this.pClass(this.output);
  output.writeMessageBegin('cancleDiscountState', Thrift.MessageType.CALL, this.seqid());
  var args = new ScoreCardServ_cancleDiscountState_args();
  args.orderId = orderId;
  args.write(output);
  output.writeMessageEnd();
  return this.output.flush();
...
ScoreCardServClient.prototype.recv_cancleDiscountState = function(input,mtype,rseqid) {
  var callback = this._reqs[rseqid] || function() {};
  delete this._reqs[rseqid];
  if (mtype == Thrift.MessageType.EXCEPTION) {
    var x = new Thrift.TApplicationException();
  ...
  var result = new ScoreCardServ_cancleDiscountState_result();
  result.read(input);
  input.readMessageEnd();
  ...
  return callback('cancleDiscountState failed: unknown result');
};
ScoreCardServClient.prototype.queryDiscountState = function(couponId, callback) {
  this._seqid = this.new_seqid();
  if (callback === undefined) {
    var _defer = Q.defer();
    this._reqs[this.seqid()] = function(error, result) {
    ...
    this.send_queryDiscountState(couponId);
    return _defer.promise;
  } else {
    this._reqs[this.seqid()] = callback;
    this.send_queryDiscountState(couponId);
...
ScoreCardServClient.prototype.send_queryDiscountState = function(couponId) {
  var output = new this.pClass(this.output);
  output.writeMessageBegin('queryDiscountState', Thrift.MessageType.CALL, this.seqid());
  var args = new ScoreCardServ_queryDiscountState_args();
  args.couponId = couponId;
  args.write(output);
  output.writeMessageEnd();
  return this.output.flush();
...
ScoreCardServClient.prototype.recv_queryDiscountState = function(input,mtype,rseqid) {
  var callback = this._reqs[rseqid] || function() {};
  delete this._reqs[rseqid];
  if (mtype == Thrift.MessageType.EXCEPTION) {
    var x = new Thrift.TApplicationException();
  ...
  var result = new ScoreCardServ_queryDiscountState_result();
  result.read(input);
  input.readMessageEnd();
  ...
  return callback('queryDiscountState failed: unknown result');
};
...
ScoreCardServProcessor.prototype.process_queryUnusedCouponListByUserId = function(seqid, input, output) {
  var args = new ScoreCardServ_queryUnusedCouponListByUserId_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.queryUnusedCouponListByUserId.length === 2) {
    Q.fcall(this._handler.queryUnusedCouponListByUserId, args.userId, args.tradeCode)
      .then(function(result) {
        var result = new ScoreCardServ_queryUnusedCouponListByUserId_result({success: result});
        output.writeMessageBegin("queryUnusedCouponListByUserId", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result = new ScoreCardServ_queryUnusedCouponListByUserId_result(err);
        output.writeMessageBegin("queryUnusedCouponListByUserId", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.queryUnusedCouponListByUserId(args.userId, args.tradeCode,  function (err, result) {
      var result = new ScoreCardServ_queryUnusedCouponListByUserId_result((err != null ? err : {success: result}));
      output.writeMessageBegin("queryUnusedCouponListByUserId", Thrift.MessageType.REPLY, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
...
ScoreCardServProcessor.prototype.process_queryAllDiscountActiv = function(seqid, input, output) {
  ...
  args.read(input);
  input.readMessageEnd();
  if (this._handler.queryAllDiscountActiv.length === 1) {
    Q.fcall(this._handler.queryAllDiscountActiv, args.pagination)
      .then(function(result) {
    ...
    this._handler.queryAllDiscountActiv(args.pagination,  function (err, result) {
...
ScoreCardServProcessor.prototype.process_queryDiscountList = function(seqid, input, output) {
  ...
  args.read(input);
  input.readMessageEnd();
  if (this._handler.queryDiscountList.length === 3) {
    Q.fcall(this._handler.queryDiscountList, args.activ, args.param, args.pagination)
      .then(function(result) {
    ...
    this._handler.queryDiscountList(args.activ, args.param, args.pagination,  function (err, result) {
...
ScoreCardServProcessor.prototype.process_exportDiscountList = function(seqid, input, output) {
  var args = new ScoreCardServ_exportDiscountList_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.exportDiscountList.length === 3) {
    Q.fcall(this._handler.exportDiscountList, args.pwd, args.activId, args.param)
      .then(function(result) {
        var result = new ScoreCardServ_exportDiscountList_result({success: result});
        output.writeMessageBegin("exportDiscountList", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result = new ScoreCardServ_exportDiscountList_result(err);
        output.writeMessageBegin("exportDiscountList", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.exportDiscountList(args.pwd, args.activId, args.param,  function (err, result) {
      var result = new ScoreCardServ_exportDiscountList_result((err != null ? err : {success: result}));
      output.writeMessageBegin("exportDiscountList", Thrift.MessageType.REPLY, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
...
ScoreCardServProcessor.prototype.process_InvalidCoupon = function(seqid, input, output) {
  ...
  args.read(input);
  input.readMessageEnd();
  if (this._handler.InvalidCoupon.length === 2) {
    Q.fcall(this._handler.InvalidCoupon, args.couponId, args.adminPwd)
      .then(function(result) {
    ...
    this._handler.InvalidCoupon(args.couponId, args.adminPwd,  function (err, result) {
...
ScoreCardServProcessor.prototype.process_queryDiscountByCouponId = function(seqid, input, output) {
  var args = new ScoreCardServ_queryDiscountByCouponId_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.queryDiscountByCouponId.length === 1) {
    Q.fcall(this._handler.queryDiscountByCouponId, args.couponId)
      .then(function(result) {
        var result = new ScoreCardServ_queryDiscountByCouponId_result({success: result});
        output.writeMessageBegin("queryDiscountByCouponId", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result = new ScoreCardServ_queryDiscountByCouponId_result(err);
        output.writeMessageBegin("queryDiscountByCouponId", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.queryDiscountByCouponId(args.couponId,  function (err, result) {
      var result = new ScoreCardServ_queryDiscountByCouponId_result((err != null ? err : {success: result}));
      output.writeMessageBegin("queryDiscountByCouponId", Thrift.MessageType.REPLY, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
...
ScoreCardServProcessor.prototype.process_cancleDiscountState = function(seqid, input, output) {
  var args = new ScoreCardServ_cancleDiscountState_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.cancleDiscountState.length === 1) {
    Q.fcall(this._handler.cancleDiscountState, args.orderId)
      .then(function(result) {
        var result = new ScoreCardServ_cancleDiscountState_result({success: result});
        output.writeMessageBegin("cancleDiscountState", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result = new ScoreCardServ_cancleDiscountState_result(err);
        output.writeMessageBegin("cancleDiscountState", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.cancleDiscountState(args.orderId,  function (err, result) {
      var result = new ScoreCardServ_cancleDiscountState_result((err != null ? err : {success: result}));
      output.writeMessageBegin("cancleDiscountState", Thrift.MessageType.REPLY, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
...
ScoreCardServProcessor.prototype.process_queryDiscountState = function(seqid, input, output) {
  var args = new ScoreCardServ_queryDiscountState_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.queryDiscountState.length === 1) {
    Q.fcall(this._handler.queryDiscountState, args.couponId)
      .then(function(result) {
        var result = new ScoreCardServ_queryDiscountState_result({success: result});
        output.writeMessageBegin("queryDiscountState", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result = new ScoreCardServ_queryDiscountState_result(err);
        output.writeMessageBegin("queryDiscountState", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.queryDiscountState(args.couponId,  function (err, result) {
      var result = new ScoreCardServ_queryDiscountState_result((err != null ? err : {success: result}));
      output.writeMessageBegin("queryDiscountState", Thrift.MessageType.REPLY, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
