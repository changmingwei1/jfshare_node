...
module.exports.ServiceFactory = {
    ...
    order: function () {
        ...
        //var obj = new ThriftConfig(ip,port);
        var obj = new ThriftConfig("10.10.100.124", 1986);
        return obj;
    },
    /**
     * 买家服务
    ...
    buyer: function () {
        ...
        //var obj = new ThriftConfig(ip,port);
        var obj = new ThriftConfig("101.201.37.237", 1990);
    ...
    common: function () {
        ...
        //var obj = new ThriftConfig(ip,port);
        var obj = new ThriftConfig("101.201.37.237", 1984);
    ...
    cart: function () {
        ...
        //var obj = new ThriftConfig(ip,port);
        var obj = new ThriftConfig("101.201.37.237", 1992);
     ...
     */
    manager: function () {
        //var ip = zookeeper.getData("manager_serv_ips");
    ...
    score: function () {
        ...
        //var obj = new ThriftConfig(ip,port);
        var obj = new ThriftConfig("10.10.100.124", 2002);
     ...
     */
    expresss: function () {
        //var ip = zookeeper.getData("expresss_serv_ips");
        //var port = zookeeper.getData("expresss_port");
        //var obj = new ThriftConfig(ip,port);
    ...
    template: function () {
        ...
        //var obj = new ThriftConfig(ip,port);
        var obj = new ThriftConfig("101.201.37.237", 2004);
        return obj;
    },
    /**
     * 积分卡服务
