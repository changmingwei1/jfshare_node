...
router.post('/payOrderCreates', function (request, response, next) {
    ...
    try {
        ...
        if (arg.tradeCode == "Z8005") { //Q币
            ...
            if (Number(arg.totalSum) < 50 || Number(arg.totalSum) > 500) {
                result.code = 400;
                result.desc = "Q币仅支持50-500元的充值";
                response.json(result);
                return;
            }
        }
...
=======
=======
>>>>>>> 1afb2c3acbd275c4b265feec736979f22724ccdd
/**
 * @author YinBo on 16/4/25.
 */
...
=======
>>>>>>> 91760656789427fa6eb19ebc3ecf180aa9e5c12f
>>>>>>> 24a3ab3fa5534e9e52370962e5828bf3e681465b
module.exports = router;
>>>>>>> 1afb2c3acbd275c4b265feec736979f22724ccdd
