...
var CommonServ = require("../gen_code/CommonServ.js");
 ...
 */
var Config = thrifgtConfig.ServiceFactory.common();
/**
 *根据应用不同获取配置
 * @type {string}
 */
Config.key = lich.ServiceKey.CommonServer;
/**
 * 赋值  所有的都加这个名字  ： thriftService
 * @type {exports|module.exports}
 */
var thriftService = CommonServ;
