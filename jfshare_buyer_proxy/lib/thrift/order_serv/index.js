...
var OrderServ = require("../gen_code/OrderServ.js");
 ...
 */
var Config = thrifgtConfig.ServiceFactory.order();
/**
 *根据应用不同获取配置
 * @type {string}
 */
Config.key = lich.ServiceKey.OrderServer;
/**
 * 赋值  所有的都加这个名字  ： thriftService
 * @type {exports|module.exports}
 */
var thriftService = OrderServ;
