...
Address.prototype.addAddress = function(param,  callback) {
    ...
    Lich.wicca.invokeClient(addressServ, function(err, data) {
        ...
        if(err){
            ...
            logger.error("调用addressServ-addAddress失败  失败原因：" + JSON.string(data));
            res.code = 500;
            res.desc = "添加收货地址信息失败！";
            callback(res, null);
        }
...
Address.prototype.updateAddress = function(param,  callback) {
    ...
    Lich.wicca.invokeClient(addressServ, function(err, data) {
        ...
        if(err || data[0].code == "1"){
            logger.error("请求参数：" + JSON.stringify(param));
            logger.error("调用addressServ-updateAddress失败  失败原因 ======" + JSON.stringify(data));
            res.code = 500;
            res.desc = "列新收货地址信息失败！";
            callback(res, null);
        } else {
...
Address.prototype.setDefaultAddress = function(param,callback) {
    ...
    Lich.wicca.invokeClient(addressServ, function(err, data) {
        ...
        if(err || data[0].code == "1"){
            logger.error("请求参数：" + JSON.stringify(param));
            logger.error("调用addressServ-setDefaultAddress  失败原因 ======" + JSON.stringify(data));
            res.code = 500;
            res.desc = "设为默认地址失败！";
            callback(res, null);
        } else {
...
Address.prototype.delAddress = function(param, callback) {
    ...
    Lich.wicca.invokeClient(addressServ, function(err, data) {
        ...
        if(err || data[0].code == 1){
            logger.error("请求参数：" + JSON.stringify(param));
            logger.error("调用addressServ-delAddress失败  失败原因 ======" + JSON.stringify(data));
            res.code = 500;
            res.desc = "删除收货地址信息失败！";
            callback(res, null);
        } else {
...
Address.prototype.queryAddress = function(param, callback) {
    ...
    Lich.wicca.invokeClient(addressServ, function(err, data) {
        ...
        if(err || data[0].result.code == "1"){
            logger.error("请求参数：" + JSON.stringify(param));
            logger.error("调用addressServ-queryAddress失败  失败原因 ======" + JSON.stringify(data));
            res.code = 500;
            res.desc = "查询收货地址列表失败！";
            callback(res, null);
        } else {
...
Address.prototype.getDefaultAddress = function(param,  callback) {
    ...
    Lich.wicca.invokeClient(addressServ, function(err, data) {
        ...
        if(err){
            logger.error("请求参数：" + JSON.stringify(param));
            logger.error("调用addressServ-getDefaultAddress失败  失败原因 ======" + JSON.stringify(data));
            res.code = 500;
            res.desc = "获取默认地址失败！";
            callback(res, null);
        } else {
...
Address.prototype.getProvinces = function(callback) {
    ...
    Lich.wicca.invokeClient(commonServer, function(err, data) {
        ...
        var res = {};
        if(err||data[0].result.code == 1){
            logger.error("commonServer-getProvinces  失败原因 ======" + JSON.stringify(data));
            res.code = 500;
            res.desc = "获取省份列表失败！";
            callback(res, null);
        } else {
...
//获取城市
Address.prototype.getCitys = function(param,callback) {

    var commonServer = new Lich.InvokeBag(Lich.ServiceKey.CommonServer, "city",[param.provinceId]);
    ...
    Lich.wicca.invokeClient(commonServer, function(err, data) {
        ...
        if(err||data[0].result.code == 1){
            logger.error("请求参数：" + JSON.stringify(param));
            logger.error("commonServer-getCitys  失败原因 ======" + JSON.stringify(data));
            res.code = 500;
            res.desc = "获取市列表失败！";
            callback(res, null);
        } else {
...
//获取市县
Address.prototype.getCountys = function(param,callback) {

    var commonServer = new Lich.InvokeBag(Lich.ServiceKey.CommonServer, "county",[param.cityId]);
    ...
    Lich.wicca.invokeClient(commonServer, function(err, data) {
        ...
        if(err||data[0].result.code == 1){
            logger.error("请求参数：" + JSON.stringify(param));
            logger.error("commonServer-getcountys  失败原因 ======" + JSON.stringify(data));
            res.code = 500;
            res.desc = "获取乡镇列表失败！";
            callback(res, null);
        } else {
