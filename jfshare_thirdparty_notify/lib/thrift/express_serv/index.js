...
var ExpressServ = require("../gen_code/ExpressServ.js");
 ...
 */
var Config = thrifgtConfig.ServiceFactory.express();
/**
 *根据应用不同获取配置
 * @type {string}
 */
Config.key = lich.ServiceKey.ExpressServer;
/**
 * 赋值  所有的都加这个名字  ： thriftService
 * @type {exports|module.exports}
 */
var thriftService = ExpressServ;
