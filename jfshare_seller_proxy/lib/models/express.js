...
Expresss.prototype.add = function(params, callback){

    var ExpressInfo = new express_types.ExpressInfo({

    });

    // 获取client
    var expressOrderServ = new Lich.InvokeBag(Lich.ServiceKey.ExpresssServer, "addExpress",[0]);
    // 调用 expressOrderServ
