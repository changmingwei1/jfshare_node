...
var AddressServ = require("../gen_code/AddressServ.js");
 ...
 */
var Config = thrifgtConfig.ServiceFactory.address();
/**
 *根据应用不同获取配置
 * @type {string}
 */
Config.key = lich.ServiceKey.AddressServer;
/**
 * 赋值  所有的都加这个名字  ： thriftService
 * @type {exports|module.exports}
 */
var thriftService = AddressServ;
