...
var MessageServ = require("../gen_code/MessageServ.js");
 ...
 */
var Config = thrifgtConfig.ServiceFactory.message();
/**
 *根据应用不同获取配置
 * @type {string}
 */
Config.key = lich.ServiceKey.MessageServer;
/**
 * 赋值  所有的都加这个名字  ： thriftService
 * @type {exports|module.exports}
 */
var thriftService = MessageServ;
