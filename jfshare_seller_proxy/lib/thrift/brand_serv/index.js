...
var BrandServ = require("../gen_code/BrandServ.js");
 ...
 */
var Config = thrifgtConfig.ServiceFactory.brand();
/**
 *根据应用不同获取配置
 * @type {string}
 */
Config.key = lich.ServiceKey.BrandServer;
/**
 * 赋值  所有的都加这个名字  ： thriftService
 * @type {exports|module.exports}
 */
var thriftService = BrandServ;
