...
Handlebars.registerHelper("showImage",function(imgUrl,options){
    return new Handlebars.SafeString(_imgServ + imgUrl);
});
...
function getOptBtnsByState(state) {
    var btn_view = '<a class="btn btn-info btn-xs opt-view" href="javascript:;"><i class="glyphicon glyphicon-zoom-in icon-white"></i>查看详情</a><br/><br/>'
    var btn_review_pass = '<a class="btn btn-success btn-xs opt-agree" href="javascript:;"><i class="glyphicon glyphicon-ok icon-white"></i>同意上架</a><br/><br/>';
    var btn_review_unpass = '<a class="btn btn-warning btn-xs opt-refuse" href="javascript:;"><i class="glyphicon glyphicon-remove icon-white"></i>拒绝上架</a><br/><br/>'
